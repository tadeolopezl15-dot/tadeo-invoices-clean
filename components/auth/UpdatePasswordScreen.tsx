...
const copy = {
  es: {
    ...
    heroEyebrow: "nueva contraseña",
    heroTitleA: "Protege tu cuenta con una contraseña",
    heroTitleB: "nueva, segura y profesional",
    heroDesc:
      "Actualiza tu acceso en pocos pasos y vuelve a entrar a tu plataforma con total seguridad.",

    feature1Title: "Cambio seguro",
    feature1Desc:
      "Actualiza tu contraseña desde el enlace de recuperación enviado a tu correo.",
    feature2Title: "Acceso rápido",
    feature2Desc:
      "Vuelve a iniciar sesión con tu nueva contraseña sin procesos complicados.",
    feature3Title: "Experiencia consistente",
    feature3Desc:
      "La actualización mantiene el mismo estilo premium del resto de tu sistema.",

    secureAccess: "actualización segura",
    title: "Crear nueva contraseña",
    desc:
      "Escribe tu nueva contraseña y confirma el cambio para volver a acceder a tu cuenta.",
    ...
    metric2: "Seguridad",
    metric3: "Acceso",
    support: "Acceso renovado",
    supportDesc:
      "Una contraseña nueva fortalece la seguridad y restaura el acceso a tu cuenta.",
  },
  en: {
    badge: "Secure update",
    heroEyebrow: "new password",
    heroTitleA: "Protect your account with a",
    heroTitleB: "new, secure, and professional password",
    heroDesc:
      "Update your access in just a few steps and sign back into your platform securely.",

    feature1Title: "Secure change",
    feature1Desc:
      "Update your password from the recovery link sent to your email.",
    feature2Title: "Fast access",
    feature2Desc:
      "Sign in again with your new password without complicated steps.",
    feature3Title: "Consistent experience",
    feature3Desc:
      "The update keeps the same premium style as the rest of your system.",

    secureAccess: "secure update",
    title: "Create new password",
    desc:
      "Enter your new password and confirm the change to access your account again.",
    ...
    metric2: "Security",
    metric3: "Access",
    support: "Renewed access",
    supportDesc:
      "A new password strengthens security and restores access to your account.",
  },
} as const;
          ...
          <div className="flex w-full flex-col justify-between px-10 py-10 xl:px-16 xl:py-14">
            ...
            <div className="mt-12 rounded-[34px] border border-white/10 bg-white/[0.045] p-5 shadow-[0_30px_80px_rgba(0,0,0,0.40)] backdrop-blur-2xl">
              <div className="grid gap-4 xl:grid-cols-3">
                <MiniStat label={t.metric1} value="100%" />
                <MiniStat label={t.metric2} value="24/7" />
            ...
            <div className="relative rounded-[34px] border border-white/10 bg-white/[0.07] p-2 shadow-[0_35px_120px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
              <div className="rounded-[30px] bg-white px-6 py-7 text-slate-900 sm:px-8 sm:py-8">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                  <QuickInfo label={t.metric1} value="100%" />
                  <QuickInfo label={t.metric2} value="24/7" />
