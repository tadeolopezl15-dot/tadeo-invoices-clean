...
export default function NewInvoiceForm({
  ...
  return (
    <form action={action} className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-400">
              Información del cliente y encabezado de la factura.
            </p>
          </div>
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
          <div className="mb-6 flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">
                Agrega descripción, cantidad y precio por cada línea.
              </p>
            </div>
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
          ...
          <label className="block">
            ...
            <textarea
              name="notes"
              rows={5}
              placeholder="Gracias por su negocio. El pago vence en la fecha indicada."
              className="w-full rounded-2xl border border-white/10 bg-slate-950/60 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-400/50 focus:ring-4 focus:ring-cyan-400/10"
            />
          </label>
        </section>
      </div>
      ...
      <aside className="space-y-6">
        ...
        <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
          <div className="space-y-3">
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 to-violet-500 px-4 py-3.5 text-sm font-semibold text-white transition hover:opacity-95"
            >
              Guardar factura
            </button>
          </div>
